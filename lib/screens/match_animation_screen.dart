            ...
            FadeTransition(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ElevatedButton(
                      // [FIX] Updated the onPressed handler to use the refactored repository method.
                      onPressed: () async {
                        ...
                        if (mounted) {
                          Navigator.of(context).pop(); // Close the animation screen
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (_) => ChatScreen(chatId: chatId, otherUsername: widget.matchedUser.username),
                          ));
                        }
                      },
