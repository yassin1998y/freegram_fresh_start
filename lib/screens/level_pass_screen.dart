  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SeasonPassBloc(
        ...
        // FIX: Added the missing required argument
...
class _LevelPassView extends StatelessWidget {
            ...
            return ListView(
              ...
              children: [
                ...
                ...rewards.map((reward) {
                  ...
                  final isClaimed =
                  user.claimedSeasonRewards.contains(reward.level);
  ...
  Widget _buildNextRewardCard(
      BuildContext context, SeasonPassReward nextReward) {
    return Card(
      elevation: 4,
