...
import 'package:freegram/widgets/gradient_progress_bar.dart';
...
class _TasksScreenView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserModel>(
      stream: locator<UserRepository>().getUserStream(currentUserId),
                ...
                Padding(
                  ...
                  child: Card(
                    ...
                    child: const SizedBox(
                      height: 120, // Adjusted height for skeleton
                      child: Center(
                        child: GradientSpinner(size: 30),
                      ),
                    ),
                  ),
                ),
                ...
                child: BlocBuilder<TasksBloc, TasksState>(
                  builder: (context, state) {
                    if (state is TasksLoading || state is TasksInitial) {
                      return const Center(child: GradientSpinner(size: 40));
                    }
                    ...
                    if (state is TasksLoaded) {
                      ...
                      // Add Proximity-based tasks to the list if they exist
  ...
  Widget _buildHeader(BuildContext context, UserModel user) {
    final xpForCurrentLevel = (user.level - 1) * 1000;
    final xpForNextLevel = user.level * 1000;
    final xpInCurrentLevel = user.xp - xpForCurrentLevel;
    final totalXpForLevel = xpForNextLevel - xpForCurrentLevel;
    final progressPercentage = (totalXpForLevel > 0)
        ? (xpInCurrentLevel / totalXpForLevel).clamp(0.0, 1.0)
        : 0.0;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                'Nearby Streak: ${user.nearbyDiscoveryStreak} Days',
