  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserModel>(
      ...
      builder: (context, userSnapshot) {
        ...
        // FIX: Check the 'unreadFor' array to see if the chat is unread.
        final List<dynamic> unreadFor = chatData['unreadFor'] ?? [];
        final bool isUnread = unreadFor.contains(currentUserId);
        ...
        return Dismissible(
          ...
          child: ListTile(
            ...
            trailing: Column(
              ...
              children: [
                if (isUnread) // FIX: Use the new boolean flag here.
                  const CircleAvatar(
                    radius: 10,
                    backgroundColor: Color(0xFFE74C3C),
                    child: Text(
                      '!', // A simple indicator is often better than a count of 1.
