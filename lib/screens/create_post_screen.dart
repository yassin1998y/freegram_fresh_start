...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Future<void> _pickImage() async {
    try {
      // FIX: Added imageQuality and maxWidth to compress and resize images before upload.
      final XFile? pickedFile = await _picker.pickImage(
        source: widget.imageSource,
        imageQuality: 85, // Compress to 85% of original quality
        maxWidth: 1920, // Max width of 1920px to prevent huge file uploads
      );
      if (pickedFile != null) {
        setState(() {
